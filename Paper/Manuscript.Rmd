...
```{r include = FALSE}
pkgs <- c("here", "knitr", "ggpmisc", "gt", "grateful", "base", "rticles")
...
``` {r petalwidths, message=FALSE, fig.width = 8, fig.height = 4.5, fig.cap = "Iris petal widths by species" }
df %>%
    ggplot() + 
...
- Whether or not figures are included inline with text appears to depend of the version of LaTeX the document is compiled with. Compiling on a computer where TinyTeX is installed (eg in the Binder associated with the reporsitory for this project on GitHub) will render the figures inline, whereas compiling the same document on a Windows computer with MikTeX installed does not
