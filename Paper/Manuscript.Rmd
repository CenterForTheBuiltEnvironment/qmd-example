...
### Add note on citing software
- TODO

## Other packages
There are lots of packages that are useful for markdown docs. We encourage you to search for these whenever you encounter a new thing you need to do and to propose an addition to this repository accordingly.`
