...
Here are some examples of how to format text with Markdown.

### Level 3 heading

Here's how to **bold** or *italicize* a piece of text.
...
```{r include=FALSE}
cite_packages(out.format = "md", out.dir =  here("/Paper/SupplementaryMaterial"))
...
cites <- grateful::get_citations(pkgs, filename = "pkg-refs.bib", out.dir =  here("/Paper/SupplementaryMaterial") )
```
